...
- MST++: [tests/test_data/s3/buckets/weights/mst_plus_plus/Readme.md](tests/test_data/s3/buckets/weights/mst_plus_plus/Readme.md)
...
| `use_brightness_adjustment_lm` | boolean | yes | MST++による明るさ調整を行うか |
